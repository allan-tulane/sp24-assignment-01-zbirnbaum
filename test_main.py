...
def test_longest_run_recursive_none():
  assert to_value(
      longest_run_recursive([2, 12, 12, 8, 12, 12, 12, 0, 12, 1], 999)) == 0
...
def test_longest_run_recursive2():
  assert to_value(longest_run_recursive([12, 12, 12, 8, 12, 12, 0, 12, 1],
                                        12)) == 3
  assert to_value(
      longest_run_recursive([12, 12, 12, 8, 12, 12, 0, 12, 12, 12, 12],
                            12)) == 4
